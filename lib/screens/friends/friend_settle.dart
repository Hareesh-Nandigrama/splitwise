...
class SettleConfirmPage2 extends StatefulWidget {
  final String from;
  final String to;
  final String groupId;
  final double amount;
  const SettleConfirmPage2({Key? key, required this.from, required this.to, required this.groupId, required this.amount}) : super(key: key);

  @override
  State<SettleConfirmPage2> createState() => _SettleConfirmPage2State();
}

class _SettleConfirmPage2State extends State<SettleConfirmPage2> {
